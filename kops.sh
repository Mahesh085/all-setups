...
kops create cluster --name umma.k8s.local --zones us-east-1a,us-east-1b --master-count=1 --master-size t2.medium --master-volume-size 20 --node-count=2 --node-size t2.micro --node-volume-size 20
